...
from app.core.config import create_llm_provider, get_settings
...
async def run_research(
    ...
    *,
    ...
    provider = llm or create_llm_provider(settings)
    graph = build_research_graph(provider)

    initial = initial_graph_state(question, resolved_run_id)
    ...
    completion_event = AgentEvent(
        ...
        payload={
            "question": question,
            "subtask_count": len(state.research_plan.subtasks)
